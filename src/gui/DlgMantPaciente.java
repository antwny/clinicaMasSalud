...
public class DlgMantPaciente extends JDialog implements ItemListener, ActionListener, MouseListener {
	...
	public DlgMantPaciente() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(DlgMantPaciente.class.getResource("/recursos/icons8-charity-48.png")));
		...
		btnAdicionar = crearBoton("Adicionar", 572, 21);
		btnModificar = crearBoton("Modificar", 572, 79);
		btnEliminar = crearBoton("Eliminar", 572, 141);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 252, 666, 192);
